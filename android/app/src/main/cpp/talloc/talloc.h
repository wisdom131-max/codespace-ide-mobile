...
#define talloc_reparent(old_ctx, new_ctx, ptr) ((void)(ptr))
...
#define talloc_check_name(ptr, name) (ptr)
#define talloc_set_name(ptr, fmt, ...) 
#define talloc_move(ctx, ptr) ({ __typeof__(*(ptr)) *_ret = *(ptr); *(ptr) = NULL; _ret; })
#define talloc_total_size(ptr) (0)
#define talloc_total_blocks(ptr) (0)
#define talloc_increase_ref_count(ptr) (0)
#define talloc_is_parent(ptr, ctx) (0)
#define talloc_find_parent_byname(ptr, name) (NULL)
#define talloc_vasprintf(ctx, fmt, ap) (NULL)
