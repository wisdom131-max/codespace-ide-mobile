...
| **SR03** | HIGH, replace mismatch | Modal Aa OFF searches case-insensitively but Replace All uses case-sensitive escaped Regex; it reports matched-line counts even when a visible hit remains unchanged. | `ui/panes/ProjectFileSearchPanel.kt:176-205,368-390`; ST17/ST18. |
