...
exports.ConnectorsModule = ConnectorsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([connector_token_entity_1.ConnectorToken]), jwt_1.JwtModule.register({})],
        controllers: [connectors_controller_1.ConnectorsController],
        providers: [connectors_service_1.ConnectorsService],
        exports: [connectors_service_1.ConnectorsService],
    })
], ConnectorsModule);
